...
public class Monopoly
{
    ...
    /// <summary>
    /// <c>Monopoly</c> class constructor.
    ...
    /// <summary>
    /// <c>StartGame</c> method is the starting point of the game.
    ...
    /// <summary>
    /// <c>isEndGame()</c> method checks if each player had predefined number of turns in the game to end the game.
